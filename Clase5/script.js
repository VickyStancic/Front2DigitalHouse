const listadoFelinos = [
  ...
  /* -------------------------------------------------------------------------- */
  /*                  FUNCION: renderizar tarjetas de felinos              */
  /* -------------------------------------------------------------------------- */
  
  const contenedor = document.querySelector(".contenedor")
  
  function renderizarFelinos() {
    contenedor.innerHTML = ''
  
    listadoFelinos.map( felino => {
      ...
      <i onclick="toggleHeart('${felino.id}')" class=" fa fa-heart ${felino.like ? "favorito" : ""} "> </i> 
      </div>
      `
    })
  }
